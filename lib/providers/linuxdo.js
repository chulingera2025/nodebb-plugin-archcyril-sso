...
LinuxDo.getStrategy = function (strategies) {
	...
	strategies.push({
		...
		icons: {
			...
			svg: '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 0 120 120"><clipPath id="ld-clip"><circle cx="60" cy="60" r="47"/></clipPath><circle fill="#f0f0f0" cx="60" cy="60" r="50"/><rect fill="#1c1c1e" clip-path="url(#ld-clip)" x="10" y="10" width="100" height="30"/><rect fill="#f0f0f0" clip-path="url(#ld-clip)" x="10" y="40" width="100" height="40"/><rect fill="#ffb003" clip-path="url(#ld-clip)" x="10" y="80" width="100" height="30"/></svg>',
		},
		labels: {
			login: '通过 LinuxDO 登录',
			register: '通过 LinuxDO 注册',
		},
		color: '#2d6da4',
		scope: 'read',
	});
